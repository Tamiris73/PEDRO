...
class AreaConhecimentoController {
  ...
  async index ({ request, response, view }) {
    const area_conhecimento = await AreaConhecimento.query().with(["area_conhecimento"]).fetch();
  ...
  async show ({ params, request, response, view }) {
    const area_conhecimento = await AreaConhecimento.query().where("areaconhecimento_id", params.id).fetch();
    return area_conhecimento;
  }
